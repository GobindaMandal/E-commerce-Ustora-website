                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Manage All Products</li>
                        </ol>
                        <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allproduct as $product )
                                            <tr>
                                                ...
                                                <td>
                                                    <img height="100" src="{{asset('backend/productimg/'.$product->pic)}}" alt="">
                                                </td>
                                                <td>{{$product->pro_price}}</td>
                                                <td>
                                                    @if($product->status==1)
                                                        <a href="{{ Route('product.status',$product->id) }}" class="btn btn-success btn-sm"><i class="fa-solid fa-check"></i></a>
                                                    @else
                                                        <a href="{{ Route('product.status',$product->id) }}" class="btn btn-danger btn-sm"><i class="fa-solid fa-check"></i></a>
                                                    @endif
                                                </td>
                                                <td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{ Route('product.delete',$product->id) }}" class="btn btn-danger">Yes</a>
